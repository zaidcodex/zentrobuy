            ...
            <div id="carouselExampleCaptions" class="carousel slide">
                ...
                <div style={{paddingBottom:window.innerWidth>992?"32%":"70%"}} class="carousel-inner position-relative">
                    <div style={{top:"0",backgroundColor:'black'}} class="h-100 carousel-item active position-absolute">
                        ...
                        <img src={`https://res.cloudinary.com/dextrzp2q/image/fetch/f_webp/q_60/${image}`} style={{top:'0px',opacity:0.6,objectFit:'cover'}} class="h-100 d-block w-100 " alt="This interactive picture describes our office environment" />
