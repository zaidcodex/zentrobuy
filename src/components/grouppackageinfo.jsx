        ...
        <div className='container p-4 py-5'>
            ...
            <div className=' pb-3'>
                ...
                <table class="table my-4">
                   ...
                   {date=="10"? <tbody>
                        <tr>
                            <th scope="row">11 Nights Makkah in above mention hotel</th>
                            <td><i style={{ fontSize: '25px', color: "#BB332F" }} class="mx-2 fa fa-check-square" aria-hidden="true"></i></td>
                            {/* <td>0 Meter</td> */}

                        </tr>
                        <tr>
                            <th scope="row">10 Nights Madinah in above mention hotel</th>
                            <td><i style={{ fontSize: '25px', color: "#BB332F" }} class="mx-2 fa fa-check-square" aria-hidden="true"></i></td>
                            {/* <td>0 Meter</td> */}

                        </tr>
                        <tr>
                            <th scope="row">Umrah Visa</th>
                            <td><i style={{ fontSize: '25px', color: "#BB332F" }} class="mx-2 fa fa-check-square" aria-hidden="true"></i></td>
                            {/* <td>0 Meter</td> */}

                        </tr>
                        <tr>
                            <th scope="row">Complate Transport </th>
                            <td><i style={{ fontSize: '25px', color: "#BB332F" }} class="mx-2 fa fa-check-square" aria-hidden="true"></i></td>
                            {/* <td>0 Meter</td> */}

                        </tr>
                        <tr>
                            <th scope="row">Makkah Ziarat </th>
                            <td><i style={{ fontSize: '25px', color: "#BB332F" }} class="mx-2 fa fa-check-square" aria-hidden="true"></i></td>
                            {/* <td>0 Meter</td> */}

                        </tr>
                        <tr>
                            <th scope="row">Madinah Ziarat </th>
                            <td><i style={{ fontSize: '25px', color: "#BB332F" }} class="mx-2 fa fa-check-square" aria-hidden="true"></i></td>
                            {/* <td>0 Meter</td> */}

                        </tr>
                        <tr>
                            <th scope="row">Direct Airline Ticket  - Serene / Airsial </th>
                            <td><i style={{ fontSize: '25px', color: "#BB332F" }} class="mx-2 fa fa-check-square" aria-hidden="true"></i></td>
                            {/* <td>0 Meter</td> */}
                        ...
                        <tr>
                            <th scope="row">10 Nights Makkah in above mention hotel</th>
                            <td><i style={{ fontSize: '25px', color: "#BB332F" }} class="mx-2 fa fa-check-square" aria-hidden="true"></i></td>
                            {/* <td>0 Meter</td> */}

                        </tr>
                        <tr>
                            <th scope="row">09 Nights Madinah in above mention hotel</th>
                            <td><i style={{ fontSize: '25px', color: "#BB332F" }} class="mx-2 fa fa-check-square" aria-hidden="true"></i></td>
                            {/* <td>0 Meter</td> */}
