...
export default function UmrahPackage({theArr}) {
...
<Switch>
        ...
        <UmrahCarousal image={anotherObj.image} upackage={`${anotherObj.title}`} />

        <div className="container p-4 mt-4 border-1 border">
        <div className='d-flex justify-content-between'>
          <div><b>Price: </b>{` PKR ${anotherObj.day10[3]}`}</div>
